...
func gatherConnectionChangeTrap(ahconnectionchange AhConnectionChangeTrap, trap AhTrapMsg, acc telegraf.Accumulator) {
	acc.AddFields("TrapEvent", map[string]interface{}{
		...
		"clientAuthMethod_connectionChangeTrap":  clientAuthMethodToString(ahconnectionchange.ClientAuthMethod),
		"clientEncryptMethod_connectionChangeTrap": clientEncryptMethodToString(ahconnectionchange.ClientEncryptMethod),
		"clientMacProto_connectionChangeTrap":    clientMacProtoToString(ahconnectionchange.ClientMacProto),
