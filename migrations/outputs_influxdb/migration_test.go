...
import (
	...
	_ "github.com/extremenetworks/telegraf/migrations/outputs_influxdb" // register migration
	"github.com/extremenetworks/telegraf/plugins/outputs/influxdb"      // register plugin
)
